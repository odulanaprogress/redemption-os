    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F8F9FF] to-white flex items-center justify-center p-4">
      ...
      <Card className="relative w-full max-w-md bg-white backdrop-blur-lg border-[#E5E7EB] p-8">
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-xl text-[#0D0D0D] mb-1 font-semibold">Create Account</h2>
          <p className="text-sm text-[#6B7280]">Join the intelligent worship ecosystem</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="••••••••"
                className="pl-10 pr-10 bg-[#F8F9FF] border-[#E5E7EB] text-[#0D0D0D] placeholder:text-[#9CA3AF]"
                required
              />
              <button
                type="button"
